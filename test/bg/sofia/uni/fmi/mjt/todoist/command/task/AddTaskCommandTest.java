...
public class AddTaskCommandTest {
    ...
    void testExecuteUserNotLoggedIn() {
        ...
        assertEquals("Please login first.", addTaskCommand.execute(args, null),
    ...
    void testExecuteInvalidArgumentsCount() {
        ...
        assertEquals("Invalid arguments count", addTaskCommand.execute(args, USERNAME),
    ...
    void testExecuteInvalidArgument() {
        ...
        assertEquals("First param should be name=<name>", addTaskCommand.execute(args, USERNAME),
